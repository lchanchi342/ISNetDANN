...
if __name__ == "__main__":
    ...
    parser.add_argument('--opt_thres_file', type=str,
                        default=Path('/home/lchanch/model_training/ISNetDANN/eval/opt_thres_sex_ISNetDANN.pkl')) #Path to the directory containing the opt_thres file .pkl
    parser.add_argument('--data_dir', type=str, default=Path('/home/lchanch/df_construction_mapping/image_mask_df')) #Directory containing dataset metadata
