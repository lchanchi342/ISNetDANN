#sweep_grid.py
#manages hyperparameter sweep jobs - handles grid search execution
...
from model_training.misc import NumpyEncoder
...
class Job:
    ...
    #Extracts argument names defined in train.py to distinguish them from additional hyperparameters.
    ...
    def __init__(self, train_args, sweep_output_root, slurm_pre, script_name, no_output_dir=False, running_jobs_list=[]):
        ...
        #If enabled, sets output folder and updates arguments.
...
if __name__ == "__main__":
    ...
    args_list = make_args_list(args.experiment) #Loads hyperparameter sttings from the selected experiment (e.g., grid_race_mimic)
